    ...
    <Card className="w-full max-w-sm mx-auto">
      ...
      <CardContent className="grid gap-4">
        ...
        <div className="grid gap-2">
          ...
          <Link to={'/reset'} className="text-sm font-semibold text-blue-500">reset password</Link>
        </div>
      </CardContent>
      <CardFooter className="flex flex-col">
        <div className="mb-3">
            ...
            <div className="sm:flex">
                ...
                <span className="text-sm text-gray-500 ms-3 dark:text-neutral-400">Doctor</span>
                </label>
                ...
                <span className="text-sm text-gray-500 ms-3 dark:text-neutral-400">Admin</span>
                </label>
            </div>
            </div>
        </div>
        <button className="btn btn-blue block w-full">Sing in</button>
      </CardFooter>
    </Card>
  )
}
